...
"armv6l-linux-thread-multi-3.4.76-1-arch" or
	die "Errno architecture (armv6l-linux-thread-multi-3.4.76-1-arch) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
